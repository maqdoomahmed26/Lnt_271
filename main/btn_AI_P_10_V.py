...
def ret_btn_result():
    ...
    def Ref_DI_AI_Writedata(portname):
        try:
            with serial.Serial(portname, baudrate=115200, timeout=1) as ser:
                ...
                message = DI_Ref_Value_Hex + "01000" * 48
    ...
    Lnt_AI_P_10V_Result = [format_voltage(v) for v in voltages]

    # Print results
    print(Lnt_AI_P_10V_Result)

    return Lnt_AI_P_10V_Result

#RESULT   (Display in LnT AI 0V Column)

# Lnt_AI_P_10V_Result = [00.00, 00.00, 00.00, 00.00, 00.00, 00.00,
