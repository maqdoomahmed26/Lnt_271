...
def ret_btn_result():
    ...
    def format_voltage(voltage):
        # return "+00.00" if -0.01 <= voltage <= 0.01 else f"{voltage:+06.2f}"
    ...
    Lnt_AI_0_10V_Result = [format_voltage(v) for v in voltages]

    # Print results
    print(Lnt_AI_0_10V_Result)

    return Lnt_AI_0_10V_Result

#RESULT   (Display in LnT AI 0V Column)

# Lnt_AI_0_10V_Result = [00.00, 00.00, 00.00, 00.00, 00.00, 00.00,
